...
> **Provenance:** this file was adopted 2026-08-10 from the sister project
> [Open-Secure-ESC](https://github.com/Stab-Rabbit-coding/Open-Secure-ESC), whose
> `AGENTS.md` it reproduces with only the project description changed. The two
> designs share a hardware root of trust and must share the same evidentiary
> standard. Upstream LibreServo (Luisonson/LibreServo_v2) is not governed by it.
...
in a safety-relevant hardware project (smart servo controller + hardware root
of trust). Violating these rules is a defect, not a style issue.
