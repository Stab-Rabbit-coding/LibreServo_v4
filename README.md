...
A few characteristics of LibreServo:
    ...
    Amp: Up to 16A continuous (WSD3069DN56) (Version >2.3) [60] — matches the datasheet's own Product Summary and N-Channel Absolute Maximum Ratings exactly (I_D = 16A, T_C = 25°C; derates to 10.5A at T_C = 100°C — see [60]).
